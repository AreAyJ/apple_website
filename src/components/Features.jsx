    ...
    useGSAP(()=>{
        gsap.to('#exploreVideo', {
            scrollTrigger: {
              ...
              toggleActions: 'play pause restart reverse restart',
              start: '-10% bottom',
            },
            onComplete:()=>{
                        ...
                        <div className='feature-text-container'>
                            <div className='flex-1 flex-center'>
                                <p className='feature-text g_text'>iPhone 15 Pro is {' '}
                                    ...
                                    spacecrafts use for missions to Mars.

                                </p>
                            </div>

                            <div className='flex-1 flex-center'>
                                <p className='feature-text g_text'>Titanium has one of the best 
                                    strength-to-wright ratios of any metal, making these our  {' '}
                                    <span className='text-white'>
